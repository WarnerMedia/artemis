...
exec(open("json_report/__version__.py").read())
...
setup(
    ...
    description="JSON Report Lambda",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url=("https://github.com/warnermedia/artemis/backend/lambdas/generators/json_report"),
