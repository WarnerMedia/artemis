...
exec(open("event_dispatch/__version__.py").read())
...
setup(
    ...
    description="Event Dispatch Lambda",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url=("https://github.com/warnermedia/artemis/backend/lambdas/events/event_dispatch"),
