...
exec(open("sbom_components/__version__.py").read())
...
setup(
    ...
    description="SBOM Components API Lambda",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url=("https://github.com/warnermedia/artemis/backend/lambdas/api/sbom_components"),
