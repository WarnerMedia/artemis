...
exec(open("system_services/__version__.py").read())
...
setup(
    ...
    description="System Services API Lambda",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url=("https://github.com/warnermedia/artemis/backend/lambdas/api/system_services"),
