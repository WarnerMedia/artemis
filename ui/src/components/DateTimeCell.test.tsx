...
import DateTimeCell, { ExpiringDateTimeCell } from "./DateTimeCell";
...
describe("DateTimeCell component", () => {
	...
	it("valid date, short (default) format", () => {
		...
		expect(
			screen.getByTitle("Wednesday, August 11, 2021, 6:46:24 PM EDT")
		).toBeInTheDocument();
	...
	it("valid date, long format", () => {
		...
		expect(
			screen.getByText("Wednesday, August 11, 2021, 6:46:24 PM EDT")
		).toBeInTheDocument();
	});
});
